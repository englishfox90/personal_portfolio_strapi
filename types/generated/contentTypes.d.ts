...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    heroBackground: Schema.Attribute.Media<'images' | 'files'>;
    ...
    > &
      Schema.Attribute.Private;
    photographerBody: Schema.Attribute.Blocks;
    photographerTitle: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    remoteSection: Schema.Attribute.Component<'about.remote-section', false>;
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    socials: Schema.Attribute.Component<'blog.socials', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCurrentlyImagingCurrentlyImaging
  extends Struct.SingleTypeSchema {
  collectionName: 'currently_imagings';
  info: {
    displayName: 'Currently Imaging';
    pluralName: 'currently-imagings';
    singularName: 'currently-imaging';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    acquisition: Schema.Attribute.Component<
      'nina-data-sync.acquisition-object',
      false
    >;
    ...
    environment: Schema.Attribute.Component<
      'nina-data-sync.environment-object',
      false
    >;
    equipment: Schema.Attribute.Component<
      'nina-data-sync.equipment-object',
      false
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::currently-imaging.currently-imaging'
    > &
      Schema.Attribute.Private;
    metaData: Schema.Attribute.Component<'nina-data-sync.meta-object', false>;
    preview: Schema.Attribute.Component<'nina-data-sync.preview-object', false>;
    project: Schema.Attribute.Component<'nina-data-sync.project-object', false>;
    publishedAt: Schema.Attribute.DateTime;
    target: Schema.Attribute.Component<'nina-data-sync.target-object', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    seo: Schema.Attribute.Component<'blog.seo', false>;
    slug: Schema.Attribute.UID<'title'>;
    tags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
